<?php
  ...
  // Retrieve and sanitize values from cookies
    if (isset($_COOKIE['firstName']) && isset($_COOKIE['lastName']) && isset($_COOKIE['email']) && isset($_COOKIE['invoiceId']) && isset($_COOKIE['pay_for']) && isset($_COOKIE['fileToUpload'])) {
        // If all required cookies exist, set variables and mark form as submitted
        ...
        $upload = htmlspecialchars($_COOKIE['fileToUpload']);
         $isSubmitted = true; // Mark the form as already submitted
    }
