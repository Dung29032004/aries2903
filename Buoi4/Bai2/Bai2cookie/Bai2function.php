...
//     setcookie('invoiceId', '', time() - 3600, '/');
//     setcookie('pay_for', '', time() - 3600, '/');
//     setcookie('fileToUpload', '', time() - 3600, '/');
//     setcookie('content', '', time() - 3600, '/');

//     // Xóa phiên làm việc và chuyển hướng người dùng về trang hiện tại
